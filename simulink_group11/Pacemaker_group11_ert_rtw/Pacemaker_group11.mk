###########################################################################
## Makefile generated for component 'Pacemaker_group11'. 
## 
## Makefile     : Pacemaker_group11.mk
## Generated on : Sat Nov 26 03:40:52 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_group11.elf
...
PRODUCT_NAME              = Pacemaker_group11
MAKEFILE                  = Pacemaker_group11.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/12791/OneDrive/Documents/GitHub/3k04-lab/simulink_group11
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Pacemaker_group11_comp.rsp
CMD_FILE                  = Pacemaker_group11.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_group11.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=66 -DMW_SERIAL0_TXBUF_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Pacemaker_group11 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o mw_sdk_interface.o MW_digitalIO.o MW_SCI.o MW_PWM.o Pacemaker_group11.o Pacemaker_group11_data.o Send_DCM.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Pacemaker_group11_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_group11_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_group11_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_group11_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_group11_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_PWM.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/freedomk64f/src/MW_PWM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Pacemaker_group11_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_group11.o : $(START_DIR)/Pacemaker_group11_ert_rtw/Pacemaker_group11.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_group11_data.o : $(START_DIR)/Pacemaker_group11_ert_rtw/Pacemaker_group11_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Send_DCM.o : $(START_DIR)/Pacemaker_group11_ert_rtw/Send_DCM.c
	$(CC) $(CFLAGS) -o "$@" "$<"
