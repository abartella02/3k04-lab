###########################################################################
## Makefile generated for component 'text'. 
## 
## Makefile     : text.mk
## Generated on : Fri Nov 25 07:28:31 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/text.elf
...
COMPILER_COMMAND_FILE     = text_comp.rsp
CMD_FILE                  = text.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/text.elf
...
DEFINES_STANDARD = -DMODEL=text -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o mw_sdk_interface.o MW_digitalIO.o MW_SCI.o Send_DCM.o text.o text_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/text_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/text_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/text_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/text_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/text_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Send_DCM.o : $(START_DIR)/text_ert_rtw/Send_DCM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


text.o : $(START_DIR)/text_ert_rtw/text.c
	$(CC) $(CFLAGS) -o "$@" "$<"


text_data.o : $(START_DIR)/text_ert_rtw/text_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
